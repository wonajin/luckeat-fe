    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 border-b flex justify-center items-center bg-white sticky top-0 z-20">
        ...
        <div className="absolute right-4 text-sm">
          {isLoggedIn ? (
            <span className="text-gray-700">{user?.nickname || '사용자'}님</span>
          ) : (
      ...
      >
        <div className="py-2">
          <h2 className="font-bold text-lg">내 주변 마감 할인 ({filteredStores.length})</h2>
        </div>
          ...
          filteredStores.map(store => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-700 font-bold">{store.discount} 할인</p>
              </div>
            </div>
          ))
        ) : (
